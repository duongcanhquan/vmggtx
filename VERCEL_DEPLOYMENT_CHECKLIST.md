...
- [ ] Lưu ý các migration mới nhất: `042`…`045` (slug /coso); `049_user_grants.sql` = quyền kiêm nhiệm; **`050_parent_accounts.sql` = phụ huynh email+mật khẩu** (bắt buộc nếu dùng cổng Gia đình → Phụ huynh).
